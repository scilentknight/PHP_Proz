    ...
    <div class="container-fluid flex-lg-column align-items-stretch">
      ...
      <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="adminDropdown">
        <ul class="nav nav-pills flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="products-backend.php">Products</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="facilities-backend.php">Facilities</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="manage_orders.php">Manage Orders</a>
          </li>
          <li class="nav-item">
